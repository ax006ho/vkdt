...
{
  dt_log(s_log_jhf, "entering %s", "render_lighttable_center");
...
// center image view
  ...
  dt_log(s_log_jhf, "leaving %s", "render_lighttable_center");
}
...
{
  dt_log(s_log_jhf, "entering %s", "render_lighttable_header");
  ...
  dt_log(s_log_jhf, "leaving %s", "render_lighttable_header");
}
...
{
  dt_log(s_log_jhf, "entering %s", "render_lighttable");
  ...
  {
    dt_log(s_log_jhf, "case: %ld", s_popup_edit_hotkeys);
  ...
  dt_log(s_log_jhf, "leaving %s", "render_lighttable");
}
